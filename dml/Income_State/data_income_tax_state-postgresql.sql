...
VALUES
(nextval('public.hibernate_sequence'), 'AL_STATE_INCOME', 'AL State Income', 'incomeTaxBracketedMarginalRateCalculator', 'INCOME_STATE', '01', 9),
(nextval('public.hibernate_sequence'), 'AZ_STATE_INCOME', 'AZ State Income', 'incomeTaxBracketedMarginalRateCalculator', 'INCOME_STATE', '04', 9),
(nextval('public.hibernate_sequence'), 'AR_STATE_INCOME', 'AR State Income', 'incomeTaxBracketedMarginalRateCalculator', 'INCOME_STATE', '05', 9),
(nextval('public.hibernate_sequence'), 'CA_STATE_INCOME', 'CA State Income', 'incomeTaxBracketedMarginalRateCalculator', 'INCOME_STATE', '06', 9),
(nextval('public.hibernate_sequence'), 'CO_STATE_INCOME', 'CO State Income', 'incomeTaxFlatRateCalculator', 'INCOME_STATE', '08', 9),
(nextval('public.hibernate_sequence'), 'CT_STATE_INCOME', 'CT State Income', 'incomeTaxBracketedMarginalRateCalculator', 'INCOME_STATE', '09', 9),
(nextval('public.hibernate_sequence'), 'DE_STATE_INCOME', 'DE State Income', 'incomeTaxBracketedMarginalRateCalculator', 'INCOME_STATE', '10', 9),
(nextval('public.hibernate_sequence'), 'DC_STATE_INCOME', 'DC State Income', 'incomeTaxBracketedMarginalRateCalculator', 'INCOME_STATE', '11', 9),
(nextval('public.hibernate_sequence'), 'GA_STATE_INCOME', 'GA State Income', 'incomeTaxBracketedMarginalRateCalculator', 'INCOME_STATE', '13', 9),
(nextval('public.hibernate_sequence'), 'HI_STATE_INCOME', 'HI State Income', 'incomeTaxBracketedMarginalRateCalculator', 'INCOME_STATE', '15', 9),
(nextval('public.hibernate_sequence'), 'ID_STATE_INCOME', 'ID State Income', 'incomeTaxBracketedMarginalRateCalculator', 'INCOME_STATE', '16', 9),
(nextval('public.hibernate_sequence'), 'IL_STATE_INCOME', 'IL State Income', 'incomeTaxFlatRateCalculator', 'INCOME_STATE', '17', 9),
(nextval('public.hibernate_sequence'), 'IN_STATE_INCOME', 'IN State Income', 'incomeTaxFlatRateCalculator', 'INCOME_STATE', '18', 9),
(nextval('public.hibernate_sequence'), 'IA_STATE_INCOME', 'IA State Income', 'incomeTaxBracketedMarginalRateCalculator', 'INCOME_STATE', '19', 9),
(nextval('public.hibernate_sequence'), 'KS_STATE_INCOME', 'KS State Income', 'incomeTaxBracketedMarginalRateCalculator', 'INCOME_STATE', '20', 9),
(nextval('public.hibernate_sequence'), 'KY_STATE_INCOME', 'KY State Income', 'incomeTaxFlatRateCalculator', 'INCOME_STATE', '21', 9),
(nextval('public.hibernate_sequence'), 'LA_STATE_INCOME', 'LA State Income', 'incomeTaxBracketedMarginalRateCalculator', 'INCOME_STATE', '22', 9),
(nextval('public.hibernate_sequence'), 'ME_STATE_INCOME', 'ME State Income', 'incomeTaxBracketedMarginalRateCalculator', 'INCOME_STATE', '23', 9),
(nextval('public.hibernate_sequence'), 'MD_STATE_INCOME', 'MD State Income', 'incomeTaxBracketedMarginalRateCalculator', 'INCOME_STATE', '24', 9),
(nextval('public.hibernate_sequence'), 'MA_STATE_INCOME', 'MA State Income', 'incomeTaxFlatRateCalculator', 'INCOME_STATE', '25', 9),
(nextval('public.hibernate_sequence'), 'MI_STATE_INCOME', 'MI State Income', 'incomeTaxFlatRateCalculator', 'INCOME_STATE', '26', 9),
(nextval('public.hibernate_sequence'), 'MN_STATE_INCOME', 'MN State Income', 'incomeTaxBracketedMarginalRateCalculator', 'INCOME_STATE', '27', 9),
(nextval('public.hibernate_sequence'), 'MS_STATE_INCOME', 'MS State Income', 'incomeTaxBracketedMarginalRateCalculator', 'INCOME_STATE', '28', 9),
(nextval('public.hibernate_sequence'), 'MO_STATE_INCOME', 'MO State Income', 'incomeTaxBracketedMarginalRateCalculator', 'INCOME_STATE', '29', 9),
(nextval('public.hibernate_sequence'), 'MT_STATE_INCOME', 'MT State Income', 'incomeTaxBracketedMarginalRateCalculator', 'INCOME_STATE', '30', 9),
(nextval('public.hibernate_sequence'), 'NE_STATE_INCOME', 'NE State Income', 'incomeTaxBracketedMarginalRateCalculator', 'INCOME_STATE', '31', 9),
(nextval('public.hibernate_sequence'), 'NJ_STATE_INCOME', 'NJ State Income', 'incomeTaxBracketedMarginalRateCalculator', 'INCOME_STATE', '34', 9),
(nextval('public.hibernate_sequence'), 'NM_STATE_INCOME', 'NM State Income', 'incomeTaxBracketedMarginalRateCalculator', 'INCOME_STATE', '35', 9),
(nextval('public.hibernate_sequence'), 'NY_STATE_INCOME', 'NY State Income', 'incomeTaxBracketedMarginalRateCalculator', 'INCOME_STATE', '36', 9),
(nextval('public.hibernate_sequence'), 'NC_STATE_INCOME', 'NC State Income', 'incomeTaxFlatRateCalculator', 'INCOME_STATE', '37', 9),
(nextval('public.hibernate_sequence'), 'ND_STATE_INCOME', 'ND State Income', 'incomeTaxBracketedMarginalRateCalculator', 'INCOME_STATE', '38', 9),
(nextval('public.hibernate_sequence'), 'OH_STATE_INCOME', 'OH State Income', 'incomeTaxBracketedMarginalRateCalculator', 'INCOME_STATE', '39', 9),
(nextval('public.hibernate_sequence'), 'OK_STATE_INCOME', 'OK State Income', 'incomeTaxBracketedMarginalRateCalculator', 'INCOME_STATE', '40', 9),
(nextval('public.hibernate_sequence'), 'OR_STATE_INCOME', 'OR State Income', 'incomeTaxBracketedMarginalRateCalculator', 'INCOME_STATE', '41', 9),
(nextval('public.hibernate_sequence'), 'PA_STATE_INCOME', 'PA State Income', 'incomeTaxFlatRateCalculator', 'INCOME_STATE', '42', 9),
(nextval('public.hibernate_sequence'), 'RI_STATE_INCOME', 'RI State Income', 'incomeTaxBracketedMarginalRateCalculator', 'INCOME_STATE', '44', 9),
(nextval('public.hibernate_sequence'), 'SC_STATE_INCOME', 'SC State Income', 'incomeTaxBracketedMarginalRateCalculator', 'INCOME_STATE', '45', 9),
(nextval('public.hibernate_sequence'), 'UT_STATE_INCOME', 'UT State Income', 'incomeTaxFlatRateCalculator', 'INCOME_STATE', '49', 9),
(nextval('public.hibernate_sequence'), 'VT_STATE_INCOME', 'VT State Income', 'incomeTaxBracketedMarginalRateCalculator', 'INCOME_STATE', '50', 9),
(nextval('public.hibernate_sequence'), 'VA_STATE_INCOME', 'VA State Income', 'incomeTaxBracketedMarginalRateCalculator', 'INCOME_STATE', '51', 9),
(nextval('public.hibernate_sequence'), 'WV_STATE_INCOME', 'WV State Income', 'incomeTaxBracketedMarginalRateCalculator', 'INCOME_STATE', '54', 9),
(nextval('public.hibernate_sequence'), 'WI_STATE_INCOME', 'WI State Income', 'incomeTaxBracketedMarginalRateCalculator', 'INCOME_STATE', '55', 9)
;
...
(nextval('public.hibernate_sequence'), 'NY_STATE_INCOME', true, true, 8000, 16050, 8000, 11200, 0, 0, 0, 0, 1000),
