 ...
 */
public class CityALSalesImport {
    ...
    public static void main(String[] args) throws Exception {
        ...
        while (itr.hasNext()) {
            ...
            String taxType = tokens[3].replace("\"", "");
            String rateType = tokens[4].replace("\"", "");
            if ("ST".equals(taxType) && "GENER".equals(rateType)) {
                String city = tokens[1].replace("\"", "");
                ...
                String rateString = tokens[8].trim().replace("\"", "").replace("%", "");
...
//                        System.out.println();
    ...
    public static List<String> removeDuplicates(List<String> lines) {
        ...
        while (itr.hasNext()) {
            ...
            if (line.startsWith("#")) { continue; }
            String[] tokens = line.split(",");
            String key = tokens[1] + ":" + tokens[3] + ":" + tokens[4] + ":" + tokens[8];
